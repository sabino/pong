...
namespace Pong
{
    public class Ball : AssetBase2D
    {
        ...
        public void Bounce(AssetBase2D paddle)
        {
            Velocity *= 1.04f;
        ...
        public override void Update(GameTime gameTime, GameObjects gameObjects)
        {
            ...
            CheckBallCollision(gameObjects.playerLeft);
            CheckBallCollision(gameObjects.playerRight);
        }

        protected override void CheckBounds(GameObjects gameObjects)
        {
            var ball = this;
            var playerLeft = gameObjects.playerLeft;
            var playerRight = gameObjects.playerRight;
        ...
        private void CheckBallCollision(AssetBase2D paddle)
        {
            var ball = this;
